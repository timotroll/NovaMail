...
## Для сдачи (рекомендации)

- Добавьте в `README`:
  - 2–3 скриншота интерфейса (папка `docs/` или `assets/`)
  - краткое описание архитектуры (модули/классы/БД)
  - список технологий и зависимостей
- Сделайте **релиз** (Release) с `.zip` исходников (если преподаватель просит)
